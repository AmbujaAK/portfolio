 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://ambuj.co
 *
...
function getUrls(): string[] {
  ...
  urls.push('https://ambuj.co/privacidad', 'https://ambuj.co/privacy')

  // Convert to use the base URL
  return urls.map(url => url.replace('https://ambuj.co', baseUrl))
}
