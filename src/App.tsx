          ...
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            >
              <p className="text-lg text-muted-foreground mb-2">
                {lang === 'es' ? 'Hola, soy' : "Hi, I'm"} <Link to={lang === 'es' ? '/sobre-mi' : '/about'} className="text-gradient-theme font-semibold hover:opacity-80 transition-opacity">@ambuj</Link>,
              </p>
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-3">
                ...
                >
                  ...
                  {/* hero-stats:career-ops:stars */}<span className="font-medium">31.0K</span>
                  <GitFork className="w-3 h-3" />
                  {/* hero-stats:career-ops:forks */}<span>6.1K</span>
                </Link>
              </div>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <AnimatedSection delay={0.1}>
            <div className="mb-12">
              <div className="flex flex-wrap items-center gap-x-4 gap-y-1 mb-2">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl overflow-hidden bg-[#888] shrink-0">
                    <picture>
                      <source srcSet="/logo-ambuj.webp" type="image/webp" />
                      <img src="/logo-ambuj.jpg" alt={t.experience.ambuj.company} className="w-full h-full object-cover" width={40} height={40} loading="lazy" decoding="async" />
                    </picture>
                  </div>
                  <h3 className="font-display text-2xl font-bold">{t.experience.ambuj.company}</h3>
                </div>
                <Link to={lang === 'en' ? '/ambuj-irepair-founder' : '/ambuj-irepair'} className="text-sm text-primary hover:underline flex items-center gap-1">
                  ambuj irepair
                </Link>
                <span className="text-sm text-muted-foreground">{t.experience.ambuj.location}</span>
              </div>
              <p className="text-primary font-medium mb-1">{t.experience.ambuj.role}</p>
              <p className="text-sm text-muted-foreground mb-4">{t.experience.ambuj.period}</p>
              <ul className="text-sm text-muted-foreground space-y-1 mb-6">
                {t.experience.ambuj.highlights.map((h, i) => (
              ...
              <div className="pt-4 border-t border-border/50">
                <p className="text-xs text-muted-foreground/60 uppercase tracking-wider mb-4">{t.experience.ambuj.trustedBy.label}</p>
                <div className="flex flex-wrap items-center gap-x-6 gap-y-3 md:gap-x-8">
                  {t.experience.ambuj.trustedBy.logos.map((logo, i) => (
              ...
              {/* Deep dive CTA */}
              <Link to={t.experience.ambuj.caseStudyUrl} className="inline-flex items-center gap-2 mt-6 text-sm font-medium text-primary hover:text-primary/80 transition-colors duration-200 group/cta">
                <span className="px-4 py-2 rounded-lg bg-primary/10 border border-primary/30 group-hover/cta:bg-primary/20 group-hover/cta:border-primary/50 transition-all duration-200">{t.experience.ambuj.caseStudyLabel}</span>
              </Link>
            </div>
          </AnimatedSection>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-gold/15 via-gold/5 to-transparent border border-gold/30 hover:border-gold/50 transition-colors duration-200 group">
              <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                <div className="flex-1 flex flex-col">
                  ...
                  <h4 className="font-display text-2xl font-bold mb-4">{t.experience.ambuj.businessOS.title}</h4>
                  <p className="text-muted-foreground mb-6">{t.experience.ambuj.businessOS.desc}</p>
                  <ul className="text-sm text-muted-foreground space-y-2">
                    {t.experience.ambuj.businessOS.modules.map((item, i) => {
                      const icons: Record<string, React.ReactNode> = {
                  ...
                  <Link to={t.experience.ambuj.caseStudyUrl} className="inline-flex items-center gap-2 mt-auto pt-6 text-sm font-medium text-gold hover:text-gold/80 transition-colors duration-200 group/cta">
                    <span className="px-4 py-2 rounded-lg bg-gold/10 border border-gold/30 group-hover/cta:bg-gold/20 group-hover/cta:border-gold/50 transition-all duration-200">{t.experience.ambuj.businessOS.footer}</span>
                ...
                <div className="grid grid-cols-3 lg:flex lg:flex-col gap-2 lg:gap-3 mt-4 lg:mt-0">
                  {t.experience.ambuj.businessOS.metrics.map((metric, i) => (
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            ...
            <AnimatedSection delay={0.15} className="col-span-2 row-span-2">
              <div className="h-full p-6 rounded-2xl bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/20 hover:border-primary/40 transition-colors duration-200 group flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="badge px-3 py-1 bg-primary/10 text-primary">{t.experience.ambuj.jacobo.badge}</span>
                </div>
                <h4 className="font-display text-xl font-bold mb-2 group-hover:text-primary transition-colors">{t.experience.ambuj.jacobo.title}</h4>
                <p className="text-muted-foreground text-sm mb-4">{t.experience.ambuj.jacobo.desc}</p>
                <ul className="text-sm text-muted-foreground space-y-2">
                  {t.experience.ambuj.jacobo.items.map((item, i) => {
                    const icons: Record<string, React.ReactNode> = {
                ...
                <Link to={t.experience.ambuj.jacobo.caseStudyUrl} className="inline-flex items-center gap-2 mt-auto pt-4 text-sm font-medium text-primary hover:text-primary/80 transition-colors duration-200 group/cta">
                  <span className="px-4 py-2 rounded-lg bg-primary/10 border border-primary/30 group-hover/cta:bg-primary/20 group-hover/cta:border-primary/50 transition-all duration-200">{t.experience.ambuj.jacobo.soldWith}</span>
                  <ChevronRight className="w-4 h-4 group-hover/cta:translate-x-0.5 transition-transform duration-200" />
                </Link>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.2} className="col-span-2 row-span-2">
              <div className="h-full p-6 rounded-2xl bg-gradient-to-br from-accent/10 to-primary/10 border border-accent/20 hover:border-accent/40 transition-colors duration-200 group flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="badge px-3 py-1 bg-accent/10 text-accent">{t.experience.ambuj.webSeo.badge}</span>
                </div>
                <h4 className="font-display text-xl font-bold mb-2 group-hover:text-accent transition-colors">{t.experience.ambuj.webSeo.title}</h4>
                <p className="text-muted-foreground text-sm mb-4">{t.experience.ambuj.webSeo.desc}</p>
                <ul className="text-sm text-muted-foreground space-y-2">
                  {t.experience.ambuj.webSeo.items.map((item, i) => {
                    const icons: Record<string, React.ReactNode> = {
                ...
                <Link to={t.experience.ambuj.webSeo.caseStudyUrl} className="inline-flex items-center gap-2 mt-auto pt-4 text-sm font-medium text-accent hover:text-accent/80 transition-colors duration-200 group/cta">
                  <span className="px-4 py-2 rounded-lg bg-accent/10 border border-accent/30 group-hover/cta:bg-accent/20 group-hover/cta:border-accent/50 transition-all duration-200">{t.experience.ambuj.webSeo.codeAvailable}</span>
                  <ChevronRight className="w-4 h-4 group-hover/cta:translate-x-0.5 transition-transform duration-200" />
                </Link>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.25} className="col-span-2">
              <div className="h-full p-5 rounded-2xl bg-gradient-to-r from-success/10 to-success/5 border border-success/30 hover:border-success/50 transition-colors duration-200">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="font-display font-bold text-success">{t.experience.ambuj.exit}</span>
                </div>
                <p className="text-sm text-muted-foreground">{t.experience.ambuj.exitDesc}</p>
              </div>
            </AnimatedSection>

            {/* ERP card */}
            <AnimatedSection delay={0.3}>
              <Link to={t.experience.ambuj.erp.caseStudyUrl} className="block h-full p-5 rounded-2xl bg-card border border-border hover:border-primary/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 flex flex-col group/card">
                <Database className="w-5 h-5 text-primary mb-3" />
                <p className="font-medium text-sm mb-1">{t.experience.ambuj.erp.title}</p>
                <p className="text-sm text-muted-foreground">{t.experience.ambuj.erp.desc}</p>
                <div className="flex items-center justify-between mt-auto pt-3">
                  <span className="text-xs font-medium text-primary">{t.experience.ambuj.erp.metric}</span>
            ...
            <AnimatedSection delay={0.35}>
              <Link to={t.experience.ambuj.gpts.caseStudyUrl} className="block h-full p-5 rounded-2xl bg-card border border-border hover:border-primary/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 flex flex-col group/card">
                <Bot className="w-5 h-5 text-accent mb-3" />
                <p className="font-medium text-sm mb-1">{t.experience.ambuj.gpts.title}</p>
                <p className="text-sm text-muted-foreground">{t.experience.ambuj.gpts.desc}</p>
                <div className="flex items-center justify-between mt-auto pt-3">
                  <span className="text-xs font-medium text-primary">{t.experience.ambuj.gpts.metric}</span>
                  <ChevronRight className="w-3.5 h-3.5 text-muted-foreground/0 group-hover/card:text-primary group-hover/card:translate-x-0.5 transition-all duration-200" />
                </div>
              </Link>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.4}>
              <Link to={t.experience.ambuj.reservas.caseStudyUrl} className="block h-full p-5 rounded-2xl bg-card border border-border hover:border-primary/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 flex flex-col group/card">
                <Timer className="w-5 h-5 text-primary mb-3" />
                <p className="font-medium text-sm mb-1">{t.experience.ambuj.reservas.title}</p>
                <p className="text-sm text-muted-foreground">{t.experience.ambuj.reservas.desc}</p>
                <div className="flex items-center justify-between mt-auto pt-3">
                  <span className="text-xs font-medium text-accent">{t.experience.ambuj.reservas.metric}</span>
                  <ChevronRight className="w-3.5 h-3.5 text-muted-foreground/0 group-hover/card:text-primary group-hover/card:translate-x-0.5 transition-all duration-200" />
                </div>
              </Link>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.45}>
              <Link to={t.experience.ambuj.crm.caseStudyUrl} className="block h-full p-5 rounded-2xl bg-card border border-border hover:border-primary/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 flex flex-col group/card">
                <Users className="w-5 h-5 text-accent mb-3" />
                <p className="font-medium text-sm mb-1">{t.experience.ambuj.crm.title}</p>
                <p className="text-sm text-muted-foreground">{t.experience.ambuj.crm.desc}</p>
                <div className="flex items-center justify-between mt-auto pt-3">
                  <span className="text-xs font-medium text-primary">{t.experience.ambuj.crm.metric}</span>
                  <ChevronRight className="w-3.5 h-3.5 text-muted-foreground/0 group-hover/card:text-primary group-hover/card:translate-x-0.5 transition-all duration-200" />
                </div>
              </Link>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.5}>
              <Link to={t.experience.ambuj.genAI.caseStudyUrl} className="block h-full p-5 rounded-2xl bg-card border border-border hover:border-primary/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-primary/5 transition-all duration-200 flex flex-col group/card">
                <Sparkles className="w-5 h-5 text-primary mb-3" />
                <p className="font-medium text-sm mb-1">{t.experience.ambuj.genAI.title}</p>
                <p className="text-sm text-muted-foreground">{t.experience.ambuj.genAI.desc}</p>
                <div className="flex items-center justify-between mt-auto pt-3">
                  <span className="text-xs font-medium text-accent">{t.experience.ambuj.genAI.metric}</span>
                  <ChevronRight className="w-3.5 h-3.5 text-muted-foreground/0 group-hover/card:text-primary group-hover/card:translate-x-0.5 transition-all duration-200" />
                </div>
              </Link>
            </AnimatedSection>
          ...
          <AnimatedSection delay={0.5} className="mt-16">
            <div className="mb-6">
              ...
              {/* Testimonial */}
              <a href="https://www.linkedin.com/in/ambuj/details/recommendations/" target="_blank" rel="noopener noreferrer" className="block group">
      ...
      <section id="projects" className="py-16 md:py-24" style={{ contentVisibility: 'auto', containIntrinsicSize: 'auto 1500px' }}>
        <div className="max-w-5xl mx-auto px-6">
          ...
          {(() => {
            ...
            const ambujIo = allProjects.find(p => p.title === 'ambuj.co')!
            const selfHealingChatbot = allProjects.find(p => p.title === 'Self-Healing Chatbot')!
            // Tools que dependen de ambuj.co
            ...
            const cardRefs = {
              ...
              ambujIo: useRef<HTMLDivElement>(null),
            ...
            useEffect(() => {
              ...
              const calculate = () => {
                ...
                const connections: Connection[] = isMobile ? [
                  ...
                  { from: cardRefs.careerOps, fromEdge: 'bottom', to: cardRefs.ambujIo, toEdge: 'top' },
                  { from: cardRefs.ambujIo, fromEdge: 'bottom', to: cardRefs.selfHealingChatbot, toEdge: 'top' },
                  ...
                  // Fila 1 → Fila 2: diagonales hacia ambuj.co + chatbot
                  { from: cardRefs.lifeOS, fromEdge: 'bottom', to: cardRefs.ambujIo, toEdge: 'top' },
                  { from: cardRefs.careerOps, fromEdge: 'bottom', to: cardRefs.selfHealingChatbot, toEdge: 'top' },
                  // Fila 2: ambuj.co ↔ chatbot (horizontal)
                  { from: cardRefs.ambujIo, fromEdge: 'right', to: cardRefs.selfHealingChatbot, toEdge: 'left' },
                  // Fila 2 → Fila 3: hacia tools
                  { from: cardRefs.ambujIo, fromEdge: 'bottom', to: cardRefs.claudeEye, toEdge: 'top' },
            ...
            return (
              <div ref={(el) => { containerRef.current = el; visibilityRef(el) }} className="mb-12 relative">
                ...
                {/* Fila 2: ambuj.co + Self-Healing Chatbot (highlight) */}
                <div className="grid md:grid-cols-2 gap-6 mb-6 relative z-10">
                  <AnimatedSection delay={0.2}>
                    <ProjectCard project={ambujIo} variant="highlight" cardRef={cardRefs.ambujIo} />
                  </AnimatedSection>
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <div className="flex gap-4 mb-8">
                    <img src="/foto-avatar.webp" alt="ambuj" role="presentation" width={384} height={384} className="w-16 h-16 md:w-20 md:h-20 rounded-full shrink-0" />
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 flex-wrap mb-1">
                        <span className="text-base md:text-lg font-bold text-foreground">ambuj | AI Builder</span>
                      ...
                      <p className="text-sm text-muted-foreground mb-3">@ambuj</p>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <AnimatedSection delay={0.1}>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a
                href="https://linkedin.com/in/ambuj/"
                target="_blank"
                rel="noopener noreferrer"
