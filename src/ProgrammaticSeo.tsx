...
export default function ProgrammaticSeo({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: 'https://ambuj.co/pseo/og-programmatic-seo.png',
    ...
    <ArticleLayout lang={lang}>
      ...
      <article className="prose-custom">
        ...
        <Photo1
          ...
          alt={lang === 'es' ? 'Homepage de ambujirepair.es' : 'ambujirepair.es homepage'}
          width={1406} height={1345}
          caption={lang === 'es' ? 'ambujirepair.es: homepage generada con Astro SSG. Buscador de dispositivos, categorías y marcas.' : 'ambujirepair.es: homepage generated with Astro SSG. Device search, categories and brands.'}
        />
        ...
        <Photo1
          ...
          alt={lang === 'es' ? 'Página de categoría Samsung en ambujirepair.es' : 'Samsung category page on ambujirepair.es'}
        ...
        <Photo1
          ...
          alt={lang === 'es' ? 'Hero de una página de reparación en ambujirepair.es' : 'Repair page hero on ambujirepair.es'}
          width={1440} height={900}
        ...
        <Photo2
          items={[
            { src: '/pseo/ss-squarespace-mobile.webp', alt: lang === 'es' ? 'ambuj.me en Squarespace: homepage móvil' : 'ambuj.me on Squarespace: mobile homepage', width: 800, height: 1422 },
            { src: '/pseo/ss-squarespace-pricing.webp', alt: lang === 'es' ? 'ambuj.me en Squarespace: página de precios con iconos genéricos' : 'ambuj.me on Squarespace: pricing page with generic icons', width: 800, height: 1422 },
          ]}
          caption={lang === 'es' ? 'ambuj.me en Squarespace. Homepage y página de precios: iconos genéricos, sin fotos reales, sin datos del ERP.' : 'ambuj.me on Squarespace. Homepage and pricing page: generic icons, no real photos, no ERP data.'}
        />
        ...
        <Photo1
          ...
          alt={lang === 'es' ? 'SISTRIX: visibilidad orgánica de ambuj.me en declive constante desde 2019 hasta 2024' : 'SISTRIX: organic visibility of ambuj.me in constant decline from 2019 to 2024'}
        ...
        <Photo2
          items={[
            ...
            { src: '/pseo/ss-audit-sector.webp', alt: lang === 'es' ? 'SISTRIX: comparativa de visibilidad del sector en España — ambuj.me invisible frente a competidores' : 'SISTRIX: sector visibility comparison in Spain — ambuj.me invisible vs competitors', width: 2000, height: 1125 },
          ]}
          caption={lang === 'es' ? 'Izquierda: GSC muestra los clics reduciéndose a la mitad (17,3K clics, posición media 23,1). Derecha: comparativa del sector — ambuj.me es la línea roja pegada al eje X.' : 'Left: GSC shows clicks halving (17.3K clicks, avg position 23.1). Right: sector comparison — ambuj.me is the red line stuck to the X axis.'}
        />
        ...
        <DiagramZoom
          ...
          caption={lang === 'es'
            ? <>Después: Astro + Cloudflare. Lighthouse 97/100 móvil. CWV superada. <a href="https://pagespeed.web.dev/analysis/https-ambujirepair-es/rynn9cjrrs?form_factor=mobile" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Compruébalo tú mismo →</a></>
            : <>After: Astro + Cloudflare. Lighthouse 97/100 mobile. CWV passed. <a href="https://pagespeed.web.dev/analysis/https-ambujirepair-es/rynn9cjrrs?form_factor=mobile" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Check it yourself →</a></>}
        />
        ...
        <DiagramZoom
          ...
          alt={lang === 'es' ? 'Comparativa AHREFs del sector: ambuj.me con DR 0.1 y 23 backlinks vs competidores con miles' : 'AHREFs sector comparison: ambuj.me with DR 0.1 and 23 backlinks vs competitors with thousands'}
          width={2000} height={1125} hdWidth={3000} hdHeight={1688}
          caption={lang === 'es' ? 'Comparativa de fuerza de dominio (AHREFs). ambuj.me: DR 0.1, 23 backlinks. El líder (iriparo.com): DR 44, 21.430 backlinks.' : 'Domain strength comparison (AHREFs). ambuj.me: DR 0.1, 23 backlinks. Sector leader (iriparo.com): DR 44, 21,430 backlinks.'}
        />
        ...
        <CaseStudyCta
          ...
          ctaHref="mailto:hola@ambuj.co?subject=Programmatic SEO"
        />
