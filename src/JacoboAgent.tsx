...
export default function JacoboAgent({ lang = 'en' }: { lang?: Lang }) {
  ...
  useArticleSeo({
    ...
    image: 'https://ambuj.co/jacobo/og-jacobo-agent.webp',
  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <GitHubRepoBadge repo="ambuj/jacobo-workflows" stars="116" forks="34" lang={lang} />
      ...
      <article className="prose-custom">
        ...
        <InlineWorkflowDownload href={wfById['calculadora-ambuj'].href} label={t.downloads.inlineLabel} fileSize={wfById['calculadora-ambuj'].fileSize} />
